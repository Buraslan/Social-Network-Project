...
private static Scanner s = new Scanner(System.in);
    ...
    public static void main(String[]args) {
        ...
        users.add(new User("Burak", "Burak@hotmail.com","26/05/1994", "İzmir",1));
        users.add(new User("Damla", "Damla@hotmail.com", "26/05/1996", "İzmir",2));
        users.add(new User("Mustafa", "Mustafa@hotmail.com", "24/04/1996", "İzmir",3));
        users.add(new User("Mert", "Mert@hotmail.com","18/1/1994", "İzmir",4));
        users.add(new User("Meltem", "Meltem@hotmail.com", "26/05/1996", "İzmir",5));
        users.add(new User("Utku", "Utku@hotmail.com", "11/10/1996", "İzmir",6));
        users.add(new User("Gökhan", "Gökhan@hotmail.com","26/05/1994", "İzmir",7));
        users.add(new User("Tugce", "Tugce@hotmail.com", "26/05/1996", "İzmir",8));
        users.add(new User("Cagla", "Cagla@hotmail.com", "24/04/1996", "İzmir",9));
        users.add(new User("Nazlı", "kullanıcı2@hotmail.com", "24/04/1996", "İzmir",10));
